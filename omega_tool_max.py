...
#    show_plots = options.show_plots
    ...
    #print(begin, "    ", end)
    if begin>= end or (end == 0 or end == 1): 
        print("Error on calculation, please check on the gplot")
    else:
        ...
        if gamma_final <= 0:
            print("Damping mode, please check on the gplot")
            print(" gamma is: ", gamma_final, "gamma_dev is", gamma_dev_final)
            print( "omega is: ", omega_final, "omega_dev is", omega_dev_final)
        else:
            print(" gamma is: ", gamma_final, "gamma_dev is", gamma_dev_final)
            print( "omega is: ", omega_final, "omega_dev is", omega_dev_final)
